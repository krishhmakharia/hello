...
if (isset($_COOKIE["login"])) {
    ...
    <head>
        ...
        <script>
            $(document).on("click",".unblock",function(){
                ...
                $.post(
                    "unblock_user.php",{id:code},function(data){
                        if(data=="success"){
                            $("#"+code).fadeOut(1000);
                        }
                    }
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="connected.php">Connects</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
            <?php 
                        $q=mysqli_query($conn,"Select * from details Where email IN (Select email from intrested where code='$code' AND interest=2) OR code IN (Select code from intrested where email='$email' AND interest=2)  ");
                                ...
                                <div class="col-lg-7">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <button style="margin-left: 40px;" class="btn btn-danger unblock" rel="<?=$row["code"]?>">Unblock</button></td>
