...
if (isset($_COOKIE["login"])) {
    ...
    <head>
        ...
        <script>
            $(document).on("click",".block",function(){
                ...
                $.post(
                    "block_user.php",{id:code},function(data){
                        if(data=="success"){
                            $("#"+code).fadeOut(1000);
                        }
                    }
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
            <?php 
                        $q=mysqli_query($conn,"Select * from details Where email IN (Select email from intrested where code='$code' AND interest=1) OR code IN (Select code from intrested where email='$email' AND interest=1)  ");
                                ...
                                <div class="col-lg-7">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <button style="margin-left: 40px;" class="btn btn-danger block" rel="<?=$row["code"]?>">Block</button></td>
